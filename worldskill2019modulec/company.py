...
@api_view(["GET"])
@exception_handler
def getdeactivatecompanylist(request):
    row=query(SETTING["dbname"],"SELECT*FROM `company` WHERE `deactivatetime` IS NOT  NULL",[],SETTING["dbsetting"])
...
def getcompanylist(request):
    row=query(SETTING["dbname"],"SELECT*FROM `company` WHERE `deactivatetime` IS NULL",[],SETTING["dbsetting"])
...
@api_view(["PUT"])
@exception_handler
def deactivatecompany(request,id):
    row=query(SETTING["dbname"],"SELECT*FROM `company` WHERE `id`=%s AND `deactivatetime` IS NULL",[id],SETTING["dbsetting"])

    if row:
        query(SETTING["dbname"],"UPDATE `company` SET `deactivatetime`=%s WHERE `id`=%s",[nowtime(),id],SETTING["dbsetting"])
        query(SETTING["dbname"],"UPDATE `product` SET `deactivatetime`=%s WHERE `compantid`=%s",[nowtime(),id],SETTING["dbsetting"])
