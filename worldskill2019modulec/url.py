...
urlpatterns=[
    ...
    re_path("^api/v1/organizers/(?P<organizer_slug>.+)/event/(?P<event_slug>.+)$",event.getevent,name="getevent"),
    re_path("^api/v1/organizers/(?P<organizer_slug>.+)/event/(?P<event_slug>.+)/registration$",event.newevent,name="newevent"),
