...
urlpatterns=[
    ...
    re_path("^api/v1/games/(?P<slug>.+)/?$",game.getgame,name="getgame"),
    re_path("api/v1/games/(?P<slug>.+)/upload",game.uploadgame,name="uploadgame"),
    re_path("games/(?P<slug>.+)/(?P<verision>.+)",index.signup,name="signup"),
    re_path("api/v1/users/(?P<username>.+)/?$",index.signup,name="signup"),
    re_path("api/v1/games/(?P<slug>.+)/scores/?$",index.signup,name="signup"),
